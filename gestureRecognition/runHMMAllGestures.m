...
load('C:\Users\Dick\Dropbox\School\UF\2014-1 Spring\EEL6825 Pattern Recognition\Project\Programs\Data\test2\gestureData.mat');
load('C:\Users\Dick\Dropbox\School\UF\2014-1 Spring\EEL6825 Pattern Recognition\Project\Programs\Data\test2\OthersGestureData.mat')

O = 3;          %Number of coefficients in a vector (Dimension of Observation Space)
...
%% Look at the results of all user gestures (both users)
   ...
   figure()
   stem([40,50,60,70,80,90],runtimes)
   ...
   title('Comparison in Run Times for varying % Training Data')
    ...
    figure()
    plot([40,50,60,70,80,90],missclass(4:9,1))
    xlabel('Data for Training (%)')
